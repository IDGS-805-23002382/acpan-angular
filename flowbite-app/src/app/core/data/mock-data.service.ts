...
export class MockDataService {
  productos: Producto[] = [
    {
      ...
      categoria: 'Sensores',
      resumen: 'Monitoreo ambiental en tiempo real para invernaderos y naves industriales.',
      descripcion:
      ...
      imagen: 'https://images.unsplash.com/photo-1581093458791-9d42e3f6b6b0?q=80&w=800&auto=format&fit=crop',
      precioBase: 1850,
      destacado: true,
      especificaciones: [
    ...
    },
    {
      ...
      resumen: 'Automatiza ciclos de riego según humedad de suelo y pronóstico climático.',
      descripcion:
    ...
    },
    {
      ...
      resumen: 'Concentra hasta 200 dispositivos IoT y sincroniza con la nube en tiempo real.',
      descripcion:
        'Gateway robusto para ambientes industriales con soporte Modbus, MQTT y respaldo 4G en caso de falla de internet fijo.',
      imagen: 'https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=800&auto=format&fit=crop',
      precioBase: 7600,
      especificaciones: [
    ...
    },
    {
      ...
      categoria: 'Sensores',
      resumen: 'Detección de plagas y estrés hídrico mediante visión computacional.',
      descripcion:
      ...
      imagen: 'https://images.unsplash.com/photo-1516937941344-00b4e0337589?q=80&w=800&auto=format&fit=crop',
      precioBase: 5300,
      especificaciones: [
  ...
  preguntasFrecuentes: PreguntaFrecuente[] = [
    {
      pregunta: '¿Cuánto tiempo tarda la instalación de un sistema IoT completo?',
      respuesta:
  ...
  comentarios: Comentario[] = [
    {
      ...
      productoId: 2,
      calificacion: 5,
      texto: 'El controlador de riego redujo nuestro consumo de agua en un 30% desde el primer mes.',
      fecha: '2026-05-12',
      revisado: true,
    },
    {
      ...
      productoId: 1,
      calificacion: 4,
      texto: 'Muy buena precisión en los sensores, la app aún puede mejorar en notificaciones.',
      fecha: '2026-06-02',
      revisado: true,
    },
    {
      ...
      productoId: 4,
      calificacion: 5,
      texto: 'La cámara detectó una plaga antes de que fuera visible a simple vista. Excelente inversión.',
      fecha: '2026-07-01',
      revisado: false,
    },
  ];
  ...
  proveedores: Proveedor[] = [
    { id: 1, nombre: 'Componentes Electrónicos del Norte', contacto: 'Luis Ramírez', correo: 'ventas@cenorte.mx', telefono: '477 123 4567', estatus: 'activo' },
    { id: 2, nombre: 'Sensores y Electrónica SA', contacto: 'Ana Torres', correo: 'contacto@sensorelec.mx', telefono: '55 8765 4321', estatus: 'activo' },
    { id: 3, nombre: 'Importadora IoT Global', contacto: 'Carlos Peña', correo: 'compras@iotglobal.com', telefono: '33 2345 6789', estatus: 'inactivo' },
  ];

  insumos: Insumo[] = [
    { id: 1, nombre: 'Microcontrolador ESP32', unidad: 'pieza', costoUnitario: 95, stock: 320, stockMinimo: 50, proveedorId: 1 },
    { id: 2, nombre: 'Sensor DHT22', unidad: 'pieza', costoUnitario: 68, stock: 180, stockMinimo: 40, proveedorId: 2 },
    { id: 3, nombre: 'Carcasa IP65', unidad: 'pieza', costoUnitario: 45, stock: 210, stockMinimo: 60, proveedorId: 1 },
    { id: 4, nombre: 'Batería de litio 3.7V', unidad: 'pieza', costoUnitario: 120, stock: 95, stockMinimo: 30, proveedorId: 3 },
    { id: 5, nombre: 'Módulo LoRa SX1276', unidad: 'pieza', costoUnitario: 210, stock: 60, stockMinimo: 20, proveedorId: 3 },
  ];
  ...
  comprasCliente: CompraCliente[] = [
    { id: 5001, productoId: 2, fecha: '2026-04-18', total: 4200, resenaDejada: true },
    { id: 5002, productoId: 1, fecha: '2026-06-02', total: 3700, resenaDejada: true },
    { id: 5003, productoId: 4, fecha: '2026-07-10', total: 5300, resenaDejada: false },
  ];
